...
enum GPIO_pin_state {OUPUT_HIGH, INPUT_X, INPUT_LOW};
...
{
    /* Below is a stateful display of LEDs */
    static uint32_t i = 1;
    ...
    /* Start Measurement */
    static GPIO_pin_state state = INPUT_LOW;
    ...
    switch(state) {
        ...
        case OUTPUT_HIGH:
            ...
            //set the PIN lowe trigger interrupt
            state = INPUT_X;
            break;
        case INPUT_X:
            //Continue to wait
...
int main(void)
{
    ...
    // 1000 measn 100 ms timer interrupt
    TIM2->ARR = 1000;
    ...
    /* Configure the GPIO pin for touch sensing */
    // Enable GPIOC.7 as the touch sensor
    // EXTI7
